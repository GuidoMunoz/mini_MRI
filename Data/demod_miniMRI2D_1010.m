...
for i = 1:num_mediciones
    ...
    addpath("E:/average_10grads/estrella_1010/" + filename)
    filename = string(angulos(i) + "grads_0%03d.csv");
    if angulos(i) == 166
        filename = "164grads_0%03d.csv";
    end
...
space_vec = linspace(-FOV/2, FOV/2, length(mediciones_ordenadas(:,14)));
plot(space_vec*100, abs(mediciones_ordenadas(:,5)), 'o-')
hold on
